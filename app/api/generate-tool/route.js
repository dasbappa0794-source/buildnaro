...
// on the server (set it in Vercel â†’ Settings â†’ Environment Variables) â€” it is never
...
- "formula" must be a single valid math expression solvable with +, -, *, /, (), and the field ids only â€” no code, no functions, no loops, no text.
...
- Keep it practical and simple â€” favour the most common real-world interpretation of the request.`;
